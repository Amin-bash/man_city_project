	...
	render() {
		return (
			<Fade>
              ...
              <CustomButton clickButton={(event) => this.submitForm(event)}>Enroll</CustomButton>
              <div className="enroll_discl">This enrolling the disclimer test on this amazing website</div>
						</div>
					</form>
				</div>
			</Fade>
